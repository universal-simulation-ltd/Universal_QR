...
// back on following global. It is also written a second time, in `index.html`'s pre-paint
// script, and `scripts/theme.test.mjs` fails if the two ever disagree.
export type { ThemePref }

export const useThemeStore = createThemeStore('unisim-qr-theme')
